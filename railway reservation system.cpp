...
public:
    ...
    char pass[100];
    char password[100];
    void getid()        //for making database
    {
        cout<<"Enter your id:";
        cin>>id;
...
class detail                        //database of train
{
public:
    int tno;
    char tname[100];
    ...
    void getdetail()
    {
        ...
        cout<<"Destination pt:";
        cin>>dest;
        cout<<"No of seats in AC & fare per ticket:";
        cin>>c1>>c1fare;
        cout<<"No of seats in Sleeper & fare per ticket:";
        cin>>c2>>c2fare;
        cout<<"Date of travel:";
        cin>>d>>m>>y;
    }
...
public:
    ...
    void getresdet()
    {
        ...
        cout<<"Enter the class :: A- AC class S-SLEEPER class:";
        cin>>clas;
        cout<<"Date of travel:";
        cin>>d>>m>>y;
...
void manage();
void can();
void user();        //to access user mode
void database();   //To access admin mode
void res();
void reserve();
void displaypassdetail();   //details after reservation
void cancell();
void enquiry();  //enquiry display
int main()
{
    ...
    if(strcmp(pass,password)==0)
    {
        ...
        do
        {
            ...
            case 1:
                ...
                break;
            case 2:
                f.open("train.txt",ios::in|ios::out|ios::app);
                a.getdetail();
                f.write((char *) & a,sizeof(a));
                f.close();
                break;
...
void res()
{
    ...
    f2.open("pnr.txt",ios::in|ios::out|ios::app);
    int ch;
    b.getresdet();
...
void cancell()
{
    ...
    fstream f1,f2,f3;
    f1.open("train.txt",ios::in|ios::out);
    f2.open("pnr.txt",ios::in|ios::out);
    f3.open("cancel.txt",ios::in|ios::out);
...
void user()
{
    ...
    while(f.read((char *) & a,sizeof(a)))
    {
        if((strcmp(a.id,id)==0)&&(strcmp(a.pass,passwd)==0))
        {
            do
            {
...
//ASSUMPTIONS:: IT WILL CONSIDER THAT THERE IS ONLY ONE SEAT FOR THE WHOLE JOURNER FROM BOARDING TO DESTINATION OF TRAIN
//USER CANNOT ACCESS THE DATABASE IT CAN ONLY BE MANAGED BY ADMIN
